...
**`gencrew-hotel-demo-18-dbt/`** — the dbt project, the stack chosen for
this delivery.

```bash
cd gencrew-hotel-demo-18-dbt
...
Details per table: `gencrew-hotel-demo-18-dbt/INCREMENTAL.md`.
...
Formulas and grains: `gencrew-hotel-demo-18-dbt/KPI_CATALOG.md`.

## 6. Business rules

13 of 13 mapping-sheet rules were
applied automatically; the remainder are listed with reasons in
`gencrew-hotel-demo-18-dbt/BUSINESS_RULES.md` for a human to resolve.
